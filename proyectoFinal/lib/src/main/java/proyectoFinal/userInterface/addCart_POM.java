...
public class addCart_POM extends PageObject {
	...
	public static Target LBL_Book2 = Target.the("Este botón nos permite seleccionar el libro 2").located(By.xpath("//body[1]/app-root[1]/div[1]/app-libros[1]/div[3]/div[1]/div[1]/div[3]/div[2]/div[2]/div[1]/figure[1]"));
	//public static Target BTN_AddCart1 = Target.the("Este botón nos permite agreagar el elemento al carrito").located(By.xpath("//body[1]/app-root[1]/div[1]/app-libros[1]/div[3]/div[1]/div[1]/div[3]/div[2]/div[2]/div[1]/figure[1]/div[3]/div[2]/div[1]/div[1]/div[1]/a[1]/span[1]"));
	...
	public static Target BTN_AddCart2 = Target.the("Este botón nos permite agreagar el elemento al carrito").located(By.xpath("//body/app-root[1]/div[1]/app-libros[1]/div[3]/div[1]/div[1]/div[3]/div[2]/div[2]/div[1]/figure[1]/div[3]/div[2]/div[1]/div[1]/div[1]/a[1]/span[1]"));
